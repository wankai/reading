...
人类没有猎豹的腿，但是有发明了高铁；没有老鹰的翅膀，但是发明了飞机；没有河马大象的力气，但是发明了起重机和石油钻探器。其中的重要原因是人类进化出了学习能力超强的大脑，能解决一个又一个横亘在发展道路上的难题。大脑解决问题有一个特点，每当它解决一个正在发生的问题时，就会形成解决同类问题的能力。如果你教会了一个老外用筷子夹拍黄瓜，下一次碰到肉末茄子的时候他自己就会夹了，不用你教。
